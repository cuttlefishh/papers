...
# keep only the 18 PPP/Calvin genes
countsTableHo <- countsTableHo[c(229,592,884,885,1039,1269,1270,23,204,622,623,900,880,881,896,958,1782,1906),]
...
metadataHo <- metadataHo[c(229,592,884,885,1039,1269,1270,23,204,622,623,900,880,881,896,958,1782,1906),]
...
protOrRnaHo <- protOrRnaHo[c(229,592,884,885,1039,1269,1270,23,204,622,623,900,880,881,896,958,1782,1906),]
...
write.csv(mynoiseqHo.deg,file="mynoiseqHoPppCalvin.updn.inf_lt_0h.ctr_lt_0h.csv",quote = FALSE)
# write.csv(mynoiseqHo.deg1,file="mynoiseqHoPppCalvin.up.inf_lt_0h.ctr_lt_0h.csv",quote = FALSE)
# write.csv(mynoiseqHo.deg2,file="mynoiseqHoPppCalvin.dn.inf_lt_0h.ctr_lt_0h.csv",quote = FALSE)
# write.csv(mynoiseqHo@results[[1]],file="mynoiseqHoPppCalvin.all.inf_lt_0h.ctr_lt_0h.csv",quote = FALSE)
...
mynoiseqHo.deg1 = degenes(mynoiseqHo, q = 0.95, M = "up")
mynoiseqHo.deg2 = degenes(mynoiseqHo, q = 0.95, M = "down")
write.csv(mynoiseqHo.deg,file="mynoiseqHoPppCalvin.updn.inf_lt_1h.ctr_lt_1h.csv",quote = FALSE)
# write.csv(mynoiseqHo.deg1,file="mynoiseqHoPppCalvin.up.inf_lt_1h.ctr_lt_1h.csv",quote = FALSE)
# write.csv(mynoiseqHo.deg2,file="mynoiseqHoPppCalvin.dn.inf_lt_1h.ctr_lt_1h.csv",quote = FALSE)
# write.csv(mynoiseqHo@results[[1]],file="mynoiseqHoPppCalvin.all.inf_lt_1h.ctr_lt_1h.csv",quote = FALSE)
...
mynoiseqHo.deg1 = degenes(mynoiseqHo, q = 0.95, M = "up")
mynoiseqHo.deg2 = degenes(mynoiseqHo, q = 0.95, M = "down")
write.csv(mynoiseqHo.deg,file="mynoiseqHoPppCalvin.updn.inf_lt_2h.ctr_lt_2h.csv",quote = FALSE)
# write.csv(mynoiseqHo.deg1,file="mynoiseqHoPppCalvin.up.inf_lt_2h.ctr_lt_2h.csv",quote = FALSE)
# write.csv(mynoiseqHo.deg2,file="mynoiseqHoPppCalvin.dn.inf_lt_2h.ctr_lt_2h.csv",quote = FALSE)
# write.csv(mynoiseqHo@results[[1]],file="mynoiseqHoPppCalvin.all.inf_lt_2h.ctr_lt_2h.csv",quote = FALSE)
...
mynoiseqHo.deg1 = degenes(mynoiseqHo, q = 0.95, M = "up")
mynoiseqHo.deg2 = degenes(mynoiseqHo, q = 0.95, M = "down")
write.csv(mynoiseqHo.deg,file="mynoiseqHoPppCalvin.updn.inf_lt_4h.ctr_lt_4h.csv",quote = FALSE)
# write.csv(mynoiseqHo.deg1,file="mynoiseqHoPppCalvin.up.inf_lt_4h.ctr_lt_4h.csv",quote = FALSE)
# write.csv(mynoiseqHo.deg2,file="mynoiseqHoPppCalvin.dn.inf_lt_4h.ctr_lt_4h.csv",quote = FALSE)
# write.csv(mynoiseqHo@results[[1]],file="mynoiseqHoPppCalvin.all.inf_lt_4h.ctr_lt_4h.csv",quote = FALSE)
...
mynoiseqHo.deg1 = degenes(mynoiseqHo, q = 0.95, M = "up")
mynoiseqHo.deg2 = degenes(mynoiseqHo, q = 0.95, M = "down")
write.csv(mynoiseqHo.deg,file="mynoiseqHoPppCalvin.updn.inf_lt_8h.ctr_lt_8h.csv",quote = FALSE)
# write.csv(mynoiseqHo.deg1,file="mynoiseqHoPppCalvin.up.inf_lt_8h.ctr_lt_8h.csv",quote = FALSE)
# write.csv(mynoiseqHo.deg2,file="mynoiseqHoPppCalvin.dn.inf_lt_8h.ctr_lt_8h.csv",quote = FALSE)
# write.csv(mynoiseqHo@results[[1]],file="mynoiseqHoPppCalvin.all.inf_lt_8h.ctr_lt_8h.csv",quote = FALSE)
...
mynoiseqHo.deg1 = degenes(mynoiseqHo, q = 0.95, M = "up")
mynoiseqHo.deg2 = degenes(mynoiseqHo, q = 0.95, M = "down")
write.csv(mynoiseqHo.deg,file="mynoiseqHoPppCalvin.updn.inf_dk_0h.ctr_dk_0h.csv",quote = FALSE)
# write.csv(mynoiseqHo.deg1,file="mynoiseqHoPppCalvin.up.inf_dk_0h.ctr_dk_0h.csv",quote = FALSE)
# write.csv(mynoiseqHo.deg2,file="mynoiseqHoPppCalvin.dn.inf_dk_0h.ctr_dk_0h.csv",quote = FALSE)
# write.csv(mynoiseqHo@results[[1]],file="mynoiseqHoPppCalvin.all.inf_dk_0h.ctr_dk_0h.csv",quote = FALSE)
...
mynoiseqHo.deg1 = degenes(mynoiseqHo, q = 0.95, M = "up")
mynoiseqHo.deg2 = degenes(mynoiseqHo, q = 0.95, M = "down")
write.csv(mynoiseqHo.deg,file="mynoiseqHoPppCalvin.updn.inf_dk_1h.ctr_dk_1h.csv",quote = FALSE)
# write.csv(mynoiseqHo.deg1,file="mynoiseqHoPppCalvin.up.inf_dk_1h.ctr_dk_1h.csv",quote = FALSE)
# write.csv(mynoiseqHo.deg2,file="mynoiseqHoPppCalvin.dn.inf_dk_1h.ctr_dk_1h.csv",quote = FALSE)
# write.csv(mynoiseqHo@results[[1]],file="mynoiseqHoPppCalvin.all.inf_dk_1h.ctr_dk_1h.csv",quote = FALSE)
...
mynoiseqHo.deg1 = degenes(mynoiseqHo, q = 0.95, M = "up")
mynoiseqHo.deg2 = degenes(mynoiseqHo, q = 0.95, M = "down")
write.csv(mynoiseqHo.deg,file="mynoiseqHoPppCalvin.updn.inf_dk_2h.ctr_dk_2h.csv",quote = FALSE)
# write.csv(mynoiseqHo.deg1,file="mynoiseqHoPppCalvin.up.inf_dk_2h.ctr_dk_2h.csv",quote = FALSE)
# write.csv(mynoiseqHo.deg2,file="mynoiseqHoPppCalvin.dn.inf_dk_2h.ctr_dk_2h.csv",quote = FALSE)
# write.csv(mynoiseqHo@results[[1]],file="mynoiseqHoPppCalvin.all.inf_dk_2h.ctr_dk_2h.csv",quote = FALSE)
...
mynoiseqHo.deg1 = degenes(mynoiseqHo, q = 0.95, M = "up")
mynoiseqHo.deg2 = degenes(mynoiseqHo, q = 0.95, M = "down")
write.csv(mynoiseqHo.deg,file="mynoiseqHoPppCalvin.updn.inf_dk_4h.ctr_dk_4h.csv",quote = FALSE)
# write.csv(mynoiseqHo.deg1,file="mynoiseqHoPppCalvin.up.inf_dk_4h.ctr_dk_4h.csv",quote = FALSE)
# write.csv(mynoiseqHo.deg2,file="mynoiseqHoPppCalvin.dn.inf_dk_4h.ctr_dk_4h.csv",quote = FALSE)
# write.csv(mynoiseqHo@results[[1]],file="mynoiseqHoPppCalvin.all.inf_dk_4h.ctr_dk_4h.csv",quote = FALSE)
...
mynoiseqHo.deg1 = degenes(mynoiseqHo, q = 0.95, M = "up")
mynoiseqHo.deg2 = degenes(mynoiseqHo, q = 0.95, M = "down")
write.csv(mynoiseqHo.deg,file="mynoiseqHoPppCalvin.updn.inf_dk_8h.ctr_dk_8h.csv",quote = FALSE)
# write.csv(mynoiseqHo.deg1,file="mynoiseqHoPppCalvin.up.inf_dk_8h.ctr_dk_8h.csv",quote = FALSE)
# write.csv(mynoiseqHo.deg2,file="mynoiseqHoPppCalvin.dn.inf_dk_8h.ctr_dk_8h.csv",quote = FALSE)
# write.csv(mynoiseqHo@results[[1]],file="mynoiseqHoPppCalvin.all.inf_dk_8h.ctr_dk_8h.csv",quote = FALSE)
