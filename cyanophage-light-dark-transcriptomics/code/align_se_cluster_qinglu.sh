...
${scriptdir}/RNAseq_parser_gff_directional.py -i aln_se.sam -o ../results/${myname}.txt -d ${gffdir} -p > ${myname}_output.txt

/home/chisholm/rnaseq/samtools view -bF 0x10 aln_se.bam > ${myname}_forward.bam
/home/chisholm/rnaseq/samtools view -bf 0x10 aln_se.bam > ${myname}_reverse.bam

/home/chisholm/rnaseq/samtools sort ${myname}_forward.bam ${myname}_forward.sorted
/home/chisholm/rnaseq/samtools index ${myname}_forward.sorted.bam
/home/chisholm/rnaseq/samtools sort ${myname}_reverse.bam ${myname}_reverse.sorted
/home/chisholm/rnaseq/samtools index ${myname}_reverse.sorted.bam

${scriptdir}/RNAseq_getpileup_directional.py -i aln_se.sam -o ../results/${myname}.pileup > ${myname}_output.txt
