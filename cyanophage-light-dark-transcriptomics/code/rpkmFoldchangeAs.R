...
write.table(rpkmHoCtrLtAvg,quote=FALSE,col.names=FALSE,file="rpkmHoCtrLtAvgAs.tsv",sep="\t")
write.table(rpkmHoInfLtAvg,quote=FALSE,col.names=FALSE,file="rpkmHoInfLtAvgAs.tsv",sep="\t")
write.table(rpkmHoCtrDkAvg,quote=FALSE,col.names=FALSE,file="rpkmHoCtrDkAvgAs.tsv",sep="\t")
write.table(rpkmHoInfDkAvg,quote=FALSE,col.names=FALSE,file="rpkmHoInfDkAvgAs.tsv",sep="\t")
write.table(rpkmHoLtFldch,quote=FALSE,col.names=FALSE,file="rpkmHoLtFldchAs.tsv",sep="\t")
write.table(rpkmHoDkFldch,quote=FALSE,col.names=FALSE,file="rpkmHoDkFldchAs.tsv",sep="\t")
