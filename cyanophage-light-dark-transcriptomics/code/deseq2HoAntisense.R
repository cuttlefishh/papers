...
write.csv(resSigLt0h[order(resSigLt0h$pval),],file="mydeseq2HoAs.updn.inf_lt_0h.ctr_lt_0h.csv",quote = FALSE)
...
write.csv(resSigLt1h[order(resSigLt1h$pval),],file="mydeseq2HoAs.updn.inf_lt_1h.ctr_lt_1h.csv",quote = FALSE)
...
write.csv(resSigLt2h[order(resSigLt2h$pval),],file="mydeseq2HoAs.updn.inf_lt_2h.ctr_lt_2h.csv",quote = FALSE)
...
write.csv(resSigLt4h[order(resSigLt4h$pval),],file="mydeseq2HoAs.updn.inf_lt_4h.ctr_lt_4h.csv",quote = FALSE)
...
write.csv(resSigLt8h[order(resSigLt8h$pval),],file="mydeseq2HoAs.updn.inf_lt_8h.ctr_lt_8h.csv",quote = FALSE)
...
write.csv(resSigDk0h[order(resSigDk0h$pval),],file="mydeseq2HoAs.updn.inf_dk_0h.ctr_dk_0h.csv",quote = FALSE)
...
write.csv(resSigDk1h[order(resSigDk1h$pval),],file="mydeseq2HoAs.updn.inf_dk_1h.ctr_dk_1h.csv",quote = FALSE)
...
write.csv(resSigDk2h[order(resSigDk2h$pval),],file="mydeseq2HoAs.updn.inf_dk_2h.ctr_dk_2h.csv",quote = FALSE)
...
write.csv(resSigDk4h[order(resSigDk4h$pval),],file="mydeseq2HoAs.updn.inf_dk_4h.ctr_dk_4h.csv",quote = FALSE)
...
write.csv(resSigDk8h[order(resSigDk8h$pval),],file="mydeseq2HoAs.updn.inf_dk_8h.ctr_dk_8h.csv",quote = FALSE)
