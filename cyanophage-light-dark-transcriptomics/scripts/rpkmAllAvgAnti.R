...
#add row and column labels
rpkmAllAvg = matrix(rpkmAllAvg,ncol=1,dimnames=list(rownames(countsTableHo[1:2013,]),c("AllAvgAnti")))

#save RPKM counts and fold change
write.table(rpkmAllAvg,quote=FALSE,col.names=FALSE,file="rpkmAllAvgAnti.tsv",sep="\t")
