...
$usage = qq{
    ...
    fieldSwapCsv.pl <csvMulticol> <fieldToSwap> <csv2col> <fieldOld> <fieldNew>

	<csvMulticol> CSV file with one field you want to swap
        <fieldToSwap> The field you want to swap (0,1,2,...)
        <csv2col> CSV file with two columns, usually matching,new
