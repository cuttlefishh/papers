...
$usage = qq{
    ...
    noiseqPlotFold.pl <mynoiseq.all...csv> x5 <genes.tsv> <prob_cutoff>
...
foreach $line (@data0h) {
    ...
    $fold = sprintf("%1.4f", $fields[3]); #round to 4 decimal places
...
print "Gene_number\tP_0h\tP_1h\tP_2h\tP_4h\tP_8h\tM_0h\tM_1h\tM_2h\tM_4h\tM_8h\tDescription\n";
